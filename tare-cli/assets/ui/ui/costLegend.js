...
export function costBandLegend(by = "share of spend") {
    const item = (tone, label) => el("span", { class: "cost-legend-item" }, [
        el("span", { class: `cost-legend-swatch ${tone}`, "aria-hidden": "true" }),
        el("span", { text: label }),
    ]);
    return el("div", { class: "cost-legend caption", role: "img", "aria-label": `Color key by ${by}: cheaper, mid, then costlier` }, [item("cost-ok", "cheaper"), item("cost-warn", "mid"), item("cost-high", "costlier")]);
}
