...
export function tareBeam(model) {
    ...
    if (compare)
        track.appendChild(el("span", { class: "tare-beam-center" }));
    ...
    if (model.measured) {
        section.appendChild(el("p", { class: "tare-beam-measured" }, [
    ...
    if (model.gap) {
        ...
        section.appendChild(el("p", { class: "tare-beam-gap" }, [
