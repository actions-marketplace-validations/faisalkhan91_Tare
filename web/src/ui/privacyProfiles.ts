...
export interface PrivacyProfileInfo {
  value: string;
  /// Humanized label (sentence case).
  label: string;
  /// One line: what this profile keeps vs drops.
  description: string;
}

export const PRIVACY_PROFILES: PrivacyProfileInfo[] = [
  {
    value: "strict_counts",
    label: "Strict counts",
...
export function privacyProfileInfo(value: string): PrivacyProfileInfo | undefined {
...
export function privacyProfileDescription(value: string): string {
